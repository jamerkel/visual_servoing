...
PTS_IMAGE_PLANE = [[309., 290.],
                   [484., 287.],
                   [211., 254.],
                   [326., 251.]] # dummy points
######################################################
...
if __name__ == "__main__":
    ...
    x, y = homography_transformer.transformUvToXy(309,290)
    homography_transformer.draw_marker(x, y, str(rospy.Time.now()))
    rospy.spin()
